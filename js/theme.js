...
// Compatible con index.html (IDs: dark-mode-icon, btn-dark-mode)
...
/**
 * Encuentra el icono de modo oscuro (busca en index y auth).
 */
function findDarkModeIcon() {
    return document.getElementById('dark-mode-icon') || document.getElementById('auth-dark-mode-icon');
}

/**
 * Encuentra el botón de modo oscuro (busca en index y auth).
 */
function findDarkModeBtn() {
    return document.getElementById('btn-dark-mode') || document.getElementById('auth-dark-mode-btn');
}
