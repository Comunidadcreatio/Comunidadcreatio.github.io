...
import { renderEtiquetasCarrusel, resetEtiquetas } from './etiquetas.js?v=fa0db6ece8';
import { artistaActual, token, esArtista } from './auth.js?v=b2e08c086d';
import { actualizarPerfilUI, verPerfilUsuario, actualizarEstadisticas, activarTabCavents } from './perfil.js?v=3430d643b0';
