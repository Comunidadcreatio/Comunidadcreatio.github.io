...
import { renderEtiquetasCarrusel, resetEtiquetas } from './etiquetas.js?v=a9fe5f8ebd';
import { artistaActual, token, esArtista } from './auth.js?v=b2e08c086d';
import { actualizarPerfilUI, verPerfilUsuario, actualizarEstadisticas, activarTabCavents } from './perfil.js?v=74b4cd1e4b';
