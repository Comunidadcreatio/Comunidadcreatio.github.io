...
import { renderEtiquetasCarrusel, resetEtiquetas } from './etiquetas.js?v=5be40b734b';
import { artistaActual, token, esArtista } from './auth.js?v=b2e08c086d';
import { actualizarPerfilUI, verPerfilUsuario, actualizarEstadisticas, activarTabCavents } from './perfil.js?v=973ed071d1';
