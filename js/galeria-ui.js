...
import { renderEtiquetasCarrusel, resetEtiquetas } from './etiquetas.js?v=770634be65';
import { artistaActual, token, esArtista } from './auth.js?v=b2e08c086d';
import { actualizarPerfilUI, verPerfilUsuario, actualizarEstadisticas, activarTabCavents } from './perfil.js?v=764c3eb262';
