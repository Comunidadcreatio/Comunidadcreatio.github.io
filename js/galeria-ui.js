...
import { renderEtiquetasCarrusel, resetEtiquetas } from './etiquetas.js?v=ab77624b7f';
import { artistaActual, token, esArtista } from './auth.js?v=b2e08c086d';
import { actualizarPerfilUI, verPerfilUsuario, actualizarEstadisticas, activarTabCavents } from './perfil.js?v=982501db08';
