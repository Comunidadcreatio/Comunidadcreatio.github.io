...
import { renderEtiquetasCarrusel, resetEtiquetas } from './etiquetas.js?v=aaeb983d0e';
import { artistaActual, token, esArtista } from './auth.js?v=b2e08c086d';
import { actualizarPerfilUI, verPerfilUsuario, actualizarEstadisticas, activarTabCavents } from './perfil.js?v=8e2ece2d11';
