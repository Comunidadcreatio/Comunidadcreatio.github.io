...
} from './galeria-ui.js?v=51f1c35be9';
import {
...
import { setupChat, refrescarChatNoLeidos } from './chat.js?v=ab481aa745';
        ...
        list.querySelectorAll('.notif-item').forEach(item => {
            item.addEventListener('click', async () => {
                ...
                if (obraId) {
                    ...
                    // Mostrar galería
                    const galeriaUI = await import('./galeria-ui.js?v=51f1c35be9');
...
function setupEvents() {
    ...
    import('./busqueda.js?v=5fff039baa').then(m => {
        m.setupBuscador(
        ...
        if (!galeria.classList.contains('hidden')) {
            ...
            cargarGaleria(gc).then(obras => {
                mostrarGaleria(obras, gc, null, (artistaId) => {
                    import('./galeria-ui.js?v=51f1c35be9').then(m => m.verPerfilArtistaDesdeGaleria(artistaId));
                });
                setTimeout(() => {
