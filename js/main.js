...
} from './galeria-ui.js?v=72d71eb159';
import {
...
import { setupChat, refrescarChatNoLeidos } from './chat.js?v=28f17bb85a';
        ...
        list.querySelectorAll('.notif-item').forEach(item => {
            item.addEventListener('click', async () => {
                ...
                if (obraId) {
                    ...
                    // Mostrar galería
                    const galeriaUI = await import('./galeria-ui.js?v=72d71eb159');
...
function setupEvents() {
    ...
    import('./busqueda.js?v=f1ec1e6a28').then(m => {
        m.setupBuscador(
        ...
        if (!galeria.classList.contains('hidden')) {
            ...
            cargarGaleria(gc).then(obras => {
                mostrarGaleria(obras, gc, null, (artistaId) => {
                    import('./galeria-ui.js?v=72d71eb159').then(m => m.verPerfilArtistaDesdeGaleria(artistaId));
                });
                setTimeout(() => {
