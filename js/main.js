...
} from './galeria-ui.js?v=9a4be12722';
import {
...
import { setupChat, refrescarChatNoLeidos } from './chat.js?v=56dc9ea4ee';
        ...
        list.querySelectorAll('.notif-item').forEach(item => {
            item.addEventListener('click', async () => {
                ...
                if (obraId) {
                    ...
                    // Mostrar galería
                    const galeriaUI = await import('./galeria-ui.js?v=9a4be12722');
...
function setupEvents() {
    ...
    import('./busqueda.js?v=779c012e26').then(m => {
        m.setupBuscador(
        ...
        if (!galeria.classList.contains('hidden')) {
            ...
            cargarGaleria(gc).then(obras => {
                mostrarGaleria(obras, gc, null, (artistaId) => {
                    import('./galeria-ui.js?v=9a4be12722').then(m => m.verPerfilArtistaDesdeGaleria(artistaId));
                });
                setTimeout(() => {
