...
} from './galeria-ui.js?v=74fa9eba16';
import {
...
import { setupChat, refrescarChatNoLeidos } from './chat.js?v=e2d785f867';
        ...
        list.querySelectorAll('.notif-item').forEach(item => {
            item.addEventListener('click', async () => {
                ...
                if (obraId) {
                    ...
                    // Mostrar galería
                    const galeriaUI = await import('./galeria-ui.js?v=74fa9eba16');
...
function setupEvents() {
    ...
    import('./busqueda.js?v=1a719ba3d1').then(m => {
        m.setupBuscador(
        ...
        if (!galeria.classList.contains('hidden')) {
            ...
            cargarGaleria(gc).then(obras => {
                mostrarGaleria(obras, gc, null, (artistaId) => {
                    import('./galeria-ui.js?v=74fa9eba16').then(m => m.verPerfilArtistaDesdeGaleria(artistaId));
                });
                setTimeout(() => {
